...
from classes.stateTrigExpander import *
...
def run_program(seed=SEED, discount_factor=DISCOUNT_FACTOR, gaussian_width=GAUSSIAN_WIDTH,
    ...
    expander = StateTrigExpander(env.observation_space.shape[0], OBSERVATION_LIMITS, segments=segments, gaussian_width=expander_gaussian)
